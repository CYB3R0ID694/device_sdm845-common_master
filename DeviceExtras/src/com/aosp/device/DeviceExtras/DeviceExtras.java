...
*
*/
package com.aosp.device.DeviceExtras;
...
import com.aosp.device.DeviceExtras.FileUtils;
import com.aosp.device.DeviceExtras.Constants;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(),
                    com.aosp.device.DeviceExtras.FPSInfoService.class);
            if (enabled) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    com.aosp.device.DeviceExtras.HBMModeService.class);
            if (enabled) {
